...
from ipdn.model.ipdn_original import IPDN
from ipdn.utils.mask_encoder import rle_decode, rle_encode
from ipdn.utils import get_root_logger, save_pred_instances
import json
...
def main():
    ...
    logger = get_root_logger(log_file=args.checkpoint.replace('.pth', '_scanrefer.log'))
